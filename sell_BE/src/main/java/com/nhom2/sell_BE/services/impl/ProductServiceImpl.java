...
import com.nhom2.sell_BE.payload.response.DiscountTextResponse;
import com.nhom2.sell_BE.payload.response.ImgDescResponse;
...
import com.nhom2.sell_BE.payload.response.*;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDetailsResponse getProductDetails(String productId) {
        ...
        ConfigResponses config = new ConfigResponses();
